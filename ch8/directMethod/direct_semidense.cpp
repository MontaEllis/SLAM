 ...
 * RGBD Semi-dense
 ***************/ 
// the value one measured includes the 3d point and a grayscale value
struct Measurement
{
...
int main(int argc, char** argv)
{
  ...
  cv::Mat prev_color;
  // we regard the first image as reference, and use direct method to the next images
